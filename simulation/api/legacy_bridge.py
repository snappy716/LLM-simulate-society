"""Explicit old-town compatibility fixture; not imported by the campus server.

Temporary boundary until the remaining town-only systems/tests retire.
"""
...
from simulation.persistence import atomic_write_json
from simulation.api.server import CampusKernelBridge, GAME_DIR
